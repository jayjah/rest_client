...
class _RegisterRestClient implements RegisterRestClient {
  ...
  Future<List<RegisterObject>> getAll(
    ...
    final _result = await _dio.request<List<dynamic>>('/registers',
  ...
  Future<RegisterObject> getOne(id) async {
    ...
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.request<Map<String, dynamic>>('/registers/$id',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'GET',
            headers: <String, dynamic>{},
  ...
  Future<void> delete(id) async {
    ...
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    await _dio.request<void>('/registers/$id',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'DELETE',
            headers: <String, dynamic>{},
  ...
  Future<RegisterObject> post(task) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(task?.toJson() ?? <String, dynamic>{});
    final _result = await _dio.request<Map<String, dynamic>>('/registers',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'POST',
            headers: <String, dynamic>{},
