...
UserObject _$UserObjectFromJson(Map<String, dynamic> json) {
  return UserObject(
    ...
    eventParticipates: (json['eventParticipates'] as List)
        ?.map((e) => e == null
            ? null
            : UserEventObject.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    todos: (json['todos'] as List)
        ?.map((e) =>
            e == null ? null : TodoObject.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    trainingParticipates: (json['trainingParticipates'] as List)
        ?.map((e) => e == null
            ? null
...
class _UserRestClient implements UserRestClient {
  ...
  Future<UserObject> login(basicLoginToken) async {
    ArgumentError.checkNotNull(basicLoginToken, 'basicLoginToken');
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.request<Map<String, dynamic>>(
